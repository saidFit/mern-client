                  ...
                  {IsClickImage &&(
                    ...
                    <div className='flex text-sm w-full justify-around md:justify-between py-3 items-center'>
                        ...
                        {!loading_Posts ?
                         ...
                         <svg ariaHidden="true" role="status" className="inline w-4 h-4 mr-3 text-gray-0 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
